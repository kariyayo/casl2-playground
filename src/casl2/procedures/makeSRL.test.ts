  ...
  describe.each([
    {
        ...
        expected: { wordLength: 2, bytecode: [0x53, 0x10, 2], GR: 0b0001, FR: "000" }
    },
    {
        tokens: create({ operator: "SRL", operand: "GR1,3" }),
        expected: { wordLength: 2, bytecode: [0x53, 0x10, 3], GR: 0b0000, FR: "001" }
    },
    {
        tokens: create({ operator: "SRL", operand: "GR1,1,GR3" }),
        expected: { wordLength: 2, bytecode: [0x53, 0x13, 1], GR: 0b0001, FR: "000" }
    },
